...
--
-- Host: localhost
-- Generation Time: Oct 12, 2023 at 07:54 PM
...
--
-- RELATIONSHIPS FOR TABLE `gastos`:
--   `Categoria_gasto`
...
--
-- RELATIONSHIPS FOR TABLE `objetivos`:
--   `Estado_objetivo`
--       `estados` -> `Id_estado`
--   `Tipo_objetivo`
--       `tipos_objetivos` -> `Id_tipo_objetivo`
--
...
--
-- RELATIONSHIPS FOR TABLE `tipos_objetivos`:
--
...
--
-- RELATIONSHIPS FOR TABLE `usuarios_y_objetivos`:
--   `Objetivo`
